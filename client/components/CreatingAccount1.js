...
const {width,height} = Dimensions.get("window");
 ...
 const CreatingAccount1 = ()=>  {
    const [image1, setimage1] = useState("/Users/kapilthaman/Documents/GitHub/allwell/client/assets/icon.png")
    ...
    <View>
    <Text style = {styles.accountHeading1}>Please upload a primary document for the proof of medical</Text>
    </View>
