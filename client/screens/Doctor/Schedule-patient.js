...
const  Schedulepatient =()=> {
  ...
  return (
    <View style={styles.outerview1} >
      ...
      <Text style={styles.lorem1}>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eligendi similique minus quibusdam facilis nobis ipsum nihil consequuntur aperiam vel! Consequuntur officia itaque pariatur dolor qui vitae dolore eos atque? Neque!</Text>
