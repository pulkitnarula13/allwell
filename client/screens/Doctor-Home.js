...
<Image style={styles.imgstyle} source={require('../assets/icon.png')} resizeMode="contain"/>
</View>
...
<View>
<Text style={{fontWeight:"500",fontSize:15,marginTop:11,lineHeight:24}}>Languages</Text>
